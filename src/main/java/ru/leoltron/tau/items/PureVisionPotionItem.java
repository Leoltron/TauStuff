...
public class PureVisionPotionItem extends Item {
    public PureVisionPotionItem() {
        this.setMaxStackSize(1);
        this.setCreativeTab(TauStuff.tauStuffCreativeTab);
        this.setTextureName(ModInfo.modId + ":pure_vision_potion_item");
        this.setUnlocalizedName("pureVisionPotionItem");
    ...
    public ItemStack onEaten(ItemStack is, World world, EntityPlayer player) {
        ...
        if (!world.isRemote) {
            player.addPotionEffect(new PotionEffect(TauStuff.pureVisionPotion.getId(), 20 * 60 * 8, 0));
    ...
    public void addInformation(ItemStack is, EntityPlayer player, List list, boolean p_77624_4_) {
        ...
        list.add(StatCollector.translateToLocal("item.pureVisionPotionItem.desc"));
    }
}
