...
public class LightLegsPotionItem extends Item {
    public LightLegsPotionItem() {
        this.setMaxStackSize(1);
        this.setCreativeTab(TauStuff.tauStuffCreativeTab);
        this.setTextureName(ModInfo.modId + ":light_legs_potion_item");
        this.setUnlocalizedName("lightLegsPotionItem");
    ...
    public ItemStack onEaten(ItemStack is, World world, EntityPlayer player) {
        ...
        if (!world.isRemote) {
            player.addPotionEffect(new PotionEffect(TauStuff.lightLegsPotion.getId(), 20 * 60 * 4, 0));
    ...
    public void addInformation(ItemStack is, EntityPlayer player, List list, boolean p_77624_4_) {
        ...
        list.add(StatCollector.translateToLocal("item.lightLegsPotionItem.desc"));
    }
}
